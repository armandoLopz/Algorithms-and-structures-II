...
class upload:
    ...
    def createsubFoldersTxt(self):
        ...
        folder1 = self.__folder(1,"Blog", 400, datetime.datetime.now, file1, None)
        folder2 = self.__folder(2,"Futuras compras", 300, datetime.datetime.now, file2, None)
    ...
    def createFolder(self):
        ...
        folder1 = self.__folder(1,"puntes", 400, datetime.datetime.now, file1, subFolders1)
        folder2 = self.__folder(2,"Contenido Estadistico", 300, datetime.datetime.now, file2, subFolders2)
        folder3 = self.__folder(3,"Archivo diferentes", 1400, datetime.datetime.now, file3, subFolders3)
        folder4 = self.__folder(4,"Clases curso", 1500, datetime.datetime.now, file4, subFolders4)
    ...
    def createUnit(self):
        ...
        return self.__unit(1,"F:", 1024, 800, "SSD", self.createFolder())